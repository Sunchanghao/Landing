...
*/
	...
	desire_angleVel_=60*exp(fabs(orientation[3]))*pow(orientation[3],3);
  ...
  /*s_PidOut[2]为飞机坐标系下Z轴也就是飞机上下方向的速度*/
	s_PidOut[2] = 0.2*(s_PidZ.p*s_PidItemZ.difference + s_PidZ.d*s_PidItemZ.differential + s_PidZ.i*s_PidItemZ.intergral);
